...
- [func_name] The name of the entry function (e.g., "entry0" is one entry function in [*motivating_example.c*](https://github.com/seclab-ucr/SUTURE/blob/main/benchmark/motivating_example.c))  
...
So as shown above, *conf_motivating_example* specifies that there are three entry functions in [*motivating_example.c*](https://github.com/seclab-ucr/SUTURE/blob/main/benchmark/motivating_example.c): *entry0* (parameter 1 is user-controlled), *entry1* and *entry2* (no user-controlled parameters). This matches the code of [the motivating example](https://github.com/seclab-ucr/SUTURE/blob/main/benchmark/motivating_example.c).
